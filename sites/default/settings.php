 ...
 * @endcode
 */
$settings['hash_salt'] = '1PmWO8fyQ56_FE77rVYjCB52k7uAZIn_dMuSYM1FmtrpISRTVKg9iNjTKMePNuWwU5DTp43FVg';
...
$config_directories['sync'] = 'sites/default/files/config_7VedrldtSe6AaMCB64vDxVmjiOdtmMLfSboZC0tN_T3ZAuEf68OHZfwha0lSTAks6NvjlHSdmg/sync';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_pschousing_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_pschousing_dd.inc';
}
// </DDSETTINGS>
